...
export class WritePVAction extends Action {
    ...
    get pvName(): string { return this.properties.getValue(PROP_PV_NAME); }
    get value(): string { return this.properties.getValue(PROP_VALUE); }
    get timeout(): number { return this.properties.getValue(PROP_TIMEOUT); }
