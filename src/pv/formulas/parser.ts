...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c2 = function(formula: any): any { return formula; };
  ...
  const peg$c26 = function(): any { return { type: 'BooleanLiteral', value: true }; };
  const peg$c27 = function(): any { return { type: 'BooleanLiteral', value: false }; };
  const peg$c28 = peg$otherExpectation("constant");
  const peg$c29 = function(): any { return { type: 'ConstantLiteral', value: Math.PI }; };
  const peg$c30 = function(): any { return { type: 'ConstantLiteral', value: Math.E }; };
  ...
  const peg$c46 = function(chars: any): any {
  ...
  const peg$c52 = function(chars: any): any {
  ...
  const peg$c57 = function(expression: any): any { return expression; };
  const peg$c58 = function(operator: any, argument: any): any {
      return {
  ...
  const peg$c63 = function(callee: any, args: any): any {
      return {
        type: 'CallExpression',
        callee: callee,
        arguments: args
  ...
  const peg$c64 = function(args: any): any {
  ...
  const peg$c76 = function(head: any, tail: any): any {
  ...
  const peg$c93 = function(head: any, tail: any): any {
