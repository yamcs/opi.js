...
function parsesAsFloat(value: any) {
    return !isNaN(value) &&
        (Number.isInteger(parseFloat(value)) || value % 1 !== 0);
}
...
export type LocalPVType = 'VDouble' | 'VDoubleArray' | 'VString' | 'VStringArray';
...
export class LocalPV extends PV {
    ...
    setSample(sample: Sample) {
        ...
        } else if (typeof sample.value === 'string' && parsesAsFloat(sample.value)) {
