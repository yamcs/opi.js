...
export class LED extends Widget {
  ...
  get stateCount(): number {
    return this.properties.getValue(PROP_STATE_COUNT);
  }
  get bulbBorder(): number {
    return this.scale * this.properties.getValue(PROP_BULB_BORDER);
  }
  get bulbBorderColor(): Color {
    return this.properties.getValue(PROP_BULB_BORDER_COLOR);
  }
  get offLabel(): string {
  ...
  get stateColorFallback(): Color {
    return this.properties.getValue(PROP_STATE_COLOR_FALLBACK);
  }
}
