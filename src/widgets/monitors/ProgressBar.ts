...
export class ProgressBar extends Widget {
  ...
  get markerTickLength() {
    return this.scale * 10;
  }
  get markerTickLineWidth() {
    return this.scale * 2;
  }
  get markerGap() {
    return this.scale * 3;
  ...
  get colorFillbackground(): Color {
    return this.properties.getValue(PROP_COLOR_FILLBACKGROUND);
  }
  get effect3d(): boolean {
    return this.properties.getValue(PROP_EFFECT_3D);
  }
  get fillColorAlarmSensitive(): boolean {
    return this.properties.getValue(PROP_FILLCOLOR_ALARM_SENSITIVE);
  }
  get fillColor(): Color {
    return this.properties.getValue(PROP_FILL_COLOR);
  }
  get font(): Font {
  ...
  get indicatorMode(): boolean {
    return this.properties.getValue(PROP_INDICATOR_MODE);
  }
  get levelLo(): number {
  ...
  get limitsFromPv(): boolean {
    return this.properties.getValue(PROP_LIMITS_FROM_PV);
  }
  ...
  get majorTickStepHint(): number {
    return this.scale * this.properties.getValue(PROP_MAJOR_TICK_STEP_HINT);
  }
  get maximum(): number {
    return this.properties.getValue(PROP_MAXIMUM);
  }
  get origin(): number {
    return this.properties.getValue(PROP_ORIGIN);
  }
  get originIgnored(): boolean {
    return this.properties.getValue(PROP_ORIGIN_IGNORED);
  }
  get scaleFont(): Font {
    return this.properties.getValue(PROP_SCALE_FONT).scale(this.scale);
  }
  get scaleFormat(): string {
    return this.properties.getValue(PROP_SCALE_FORMAT);
  }
  get showHi(): boolean {
  ...
  get showLabel(): boolean {
    return this.properties.getValue(PROP_SHOW_LABEL);
  }
  get showLo(): boolean {
  ...
  get showMarkers(): boolean {
    return this.properties.getValue(PROP_SHOW_MARKERS);
  }
  get showMinorTicks(): boolean {
    return this.properties.getValue(PROP_SHOW_MINOR_TICKS);
  }
  get showScale(): boolean {
    return this.properties.getValue(PROP_SHOW_SCALE);
  }
  get transparentBackground(): boolean {
    return this.properties.getValue(PROP_TRANSPARENT_BACKGROUND);
  }
