...
export class Table extends Widget {
    ...
    get columnsCount(): number { return this.properties.getValue(PROP_COLUMNS_COUNT); }
    get columnHeaders(): string[][] { return this.properties.getValue(PROP_COLUMN_HEADERS); }
